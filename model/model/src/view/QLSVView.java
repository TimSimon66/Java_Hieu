...
public class QLSVView  extends JFrame {
	...
	public void thucHienTim() {
		...
		for (int j = 0; j < idCuaThiSinhCanXoa.size(); j++) {
		    Integer idCanXoa = (Integer) ((ArrayList) idCuaThiSinhCanXoa).get(j);
	...
	public void thucHienTaiLaiDuLieu() {
		...
		ArrayList<ThiSinh> dsThiSinh = this.model.getDsThiSinh();
		int size = dsThiSinh.size();
